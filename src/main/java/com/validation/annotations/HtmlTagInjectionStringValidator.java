...
public class HtmlTagInjectionStringValidator implements ConstraintValidator<HtmlTagInjectionStringValidation, Object> {


	public void initialize(HtmlTagInjectionStringValidation validate) {
	}
